...
#SBATCH -J nips18_256              # The job name
...
##- virtualenv
source /workspace/T/luguo/gxt/pyt1.5/bin/activate
...
#- Job step
python train.py --config examples/example/config.json  -n finetune -p gxt/ImageCompression/checkpoints/baseline/iter_2450000.pth.tar --finetune 
