...
def build_model():
        ...
        analysis_net = MPAnalysis_net()
        feature = analysis_net(input_image)

        print(feature.size())

class MPAnalysis_net(Analysis_net):
    def __init__(self, out_channel_N=192, out_channel_M=320):
        super(MPAnalysis_net, self).__init__(out_channel_N,out_channel_M)
