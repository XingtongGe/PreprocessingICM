...
#SBATCH -t 1-23:00:00                # Run for a maximum time of 0 days, 12 hours, 00 mins, 00 secs
...
#- Job step
python train.py --config examples/example/config.json  -n baseline/finetune_128  -p  /workspace/T/luguo/wangyancheng/ImageCompression/checkpoints/baseline/iter_2610540.pth.tar --finetune
