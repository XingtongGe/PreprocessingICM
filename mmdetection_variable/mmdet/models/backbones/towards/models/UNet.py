...
class UNet(nn.Module):
    def __init__(self):
        ...
        # Scaling_Net
        self.Scaling_Net1 = Scaling_Net(32, hidden_units=32)
        self.Scaling_Net2 = Scaling_Net(32, hidden_units=64)
        self.Scaling_Net3 = Scaling_Net(hidden_units=128)
        self.Scaling_Net4 = Scaling_Net(hidden_units=256)
        self.Scaling_Net5 = Scaling_Net(hidden_units=128)
        self.Scaling_Net6 = Scaling_Net(32, hidden_units=64)
        # 下采样
    ...
    def forward(self, x, scaling_lambda):
        ...
        m3 = self.Scaling_Net3(scaling_lambda)
        m4 = self.Scaling_Net4(scaling_lambda)
        m5 = self.Scaling_Net5(scaling_lambda)
        m6 = self.Scaling_Net6(scaling_lambda)
        out_1,out1=self.d1(x)
        out_2,out2=self.d2(out1 * m1)#
        out_3,out3=self.d3(out2 * m2)#
        out_4,out4=self.d4(out3 * m3)
        out5=self.u1(out4,out_4) 
        out6=self.u2(out5,out_3) * m4
        out7=self.u3(out6,out_2) * m5
        out8=self.u4(out7,out_1) * m6
        out=self.o(out8)
        return out
